<%@ Page Title="" Language="C#" MasterPageFile="~/Custmar/Custmarmaster.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="Bagshop.Custmar.Product" %>
    ...
    <table class="auto-style5">
        <tr>
            <td valign="top">
                ...
                <br />
&nbsp;&nbsp; </span><span class="auto-style12">Select Category ---&gt;</span><asp:DataList ID="DataList1" runat="server" DataSourceID="SqlDataSource1" CellPadding="5">
                    <ItemTemplate>
