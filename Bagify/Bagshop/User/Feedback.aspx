<%@ Page Title="" Language="C#" MasterPageFile="~/User/Usermaster.Master" AutoEventWireup="true" CodeBehind="Feedback.aspx.cs" Inherits="Bagshop.User.Feedback" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table cellpadding="2" cellspacing="1" class="auto-style5" align="center">
        ...
        <tr>
            ...
            <td colspan="4">
                <asp:TextBox ID="txtname" runat="server" Height="30px" Width="300px"></asp:TextBox>
        ...
        <tr>
            ...
            <td colspan="4">
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Enter valid email id" ForeColor="Red" ControlToValidate="txtemail" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
            </td>
        </tr>
        <tr>
            <td class="auto-style27">Contact No</td>
            <td colspan="4" class="auto-style27">
                <asp:TextBox ID="txtcontact" runat="server" Height="30px"  Width="300px"></asp:TextBox>
        ...
        <tr>
            ...
            <td class="auto-style11" colspan="3">
                &nbsp;<asp:TextBox ID="txtdate" runat="server" Height="30px" TextMode="Date" Width="300px"></asp:TextBox>
            </td>
            <td>
                &nbsp;</td>
        </tr>
        <tr>
            ...
            <td colspan="4">
                <asp:TextBox ID="txtsuggestion" runat="server" Height="62px" TextMode="MultiLine" Width="350px" CssClass="auto-style25"></asp:TextBox>
            </td>
        </tr>
        <tr>
